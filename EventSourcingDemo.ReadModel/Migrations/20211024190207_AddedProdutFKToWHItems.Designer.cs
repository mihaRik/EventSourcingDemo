...
namespace EventSourcingDemo.ReadModel.Migrations
{
    ...
    [Migration("20211024190207_AddedProdutFKToWHItems")]
    partial class AddedProdutFKToWHItems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventSourcingDemo.ReadModel.WarehouseItemReadModel", b =>
                {
                    ...
                    b.Property<Guid?>("WarehouseReadModelId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("WarehouseReadModelId");
            ...
            modelBuilder.Entity("EventSourcingDemo.ReadModel.WarehouseItemReadModel", b =>
                {
                    b.HasOne("EventSourcingDemo.ReadModel.WarehouseReadModel", null)
                        .WithMany("Items")
                        .HasForeignKey("WarehouseReadModelId");
                });
